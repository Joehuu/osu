...
namespace osu.Game.Screens.Select
{
    public partial class DifficultyNameContent : FillFlowContainer
    {
        ...
        private void updateMapper()
        {
            ...
            if (beatmapInfo.Value is APIBeatmap apiBeatmap)
            {
            ...
            {
                // TODO: should be the mapper of the guest difficulty, but that isn't stored yet
                mapperName.AddUserLink(beatmapInfo.Value.Metadata.Author);
            }
        }
