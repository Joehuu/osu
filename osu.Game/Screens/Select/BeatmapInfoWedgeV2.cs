...
{
    public partial class BeatmapInfoWedgeV2 : VisibilityContainer, ISerialisableDrawable
    {
        ...
        protected override void LoadComplete()
        {
            ...
            beatmap.BindValueChanged(b =>
            {
                ...
                basicDifficultyInfoContent.BeatmapInfo.Value = b.NewValue.BeatmapInfo;
                basicDifficultyInfoContent.BeatmapSetInfo.Value = b.NewValue.BeatmapSetInfo;
                extendedBeatmapDetailsContent.BeatmapInfo.Value = b.NewValue.BeatmapInfo;
                extendedBeatmapDetailsContent.BeatmapSetInfo.Value = b.NewValue.BeatmapSetInfo;
            }, true);
