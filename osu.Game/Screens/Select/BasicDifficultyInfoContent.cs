...
{
    public partial class BasicDifficultyInfoContent : Container, ISerialisableDrawable
    {
        ...
        private Container lengthAndBPMStatistic = null!;
                    ...
                    Children = new Drawable[]
                    {
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                lengthAndBPMStatistic = new Container
                                {
        ...
        protected override void UpdateAfterChildren()
        {
            ...
            // TODO: find a better way of truncating long difficulty names
            difficultyName.MaxWidth = ChildSize.X - mappedByLabel.DrawWidth
                                                  - creatorName.DrawWidth - 10
                                                  - lengthAndBPMStatistic.DrawWidth;
        }
