...
namespace osu.Game.Rulesets.Catch.Tests
{
    ...
    public partial class TestSceneCatchPlayerLegacySkin : LegacySkinPlayerTestScene
    {
        ...
        [Test]
        public void TestLegacyHUDComboCounterNull([Values] bool withModifiedSkin)
        {
            if (withModifiedSkin)
            {
            ...
            AddAssert("legacy HUD combo counter null", () => Player.ChildrenOfType<LegacyComboCounter>().FirstOrDefault() == null);
        }
    }
}
